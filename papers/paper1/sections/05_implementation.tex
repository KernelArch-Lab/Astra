...
8,000 lines of C++ and 335 lines of NASM.
...
delete), \texttt{asm\_ct\_select} (branchless conditional select),
\texttt{asm\_rdrand64}, \texttt{asm\_lfence},
\texttt{asm\_cache\_flush\_range}, and
\texttt{asm\_stack\_canary\_init}.
...
(\texttt{formal/cbmc/capability\_monotonicity.c}, 296 LOC) and prove
