...
\sysname measures faster than Aeron here, and we want to be precise
about why that is not the claim it might appear to be. Aeron's
...
server would not show. We therefore treat Aeron's tail on this
machine as a property of the machine, not of Aeron, and we do not
build any argument on it.
