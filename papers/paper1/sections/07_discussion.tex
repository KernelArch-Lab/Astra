...
is not the claim it might appear to be. A gap of that size should
raise a reader's suspicion rather than their confidence, and it raises
ours: an order of magnitude is the signature of two systems doing
different amounts of work, not of one being better engineered. Aeron's
